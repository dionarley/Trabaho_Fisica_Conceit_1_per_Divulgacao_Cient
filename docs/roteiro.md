...
O roteiro completo será adicionado em:
- **Arquivo principal:** `Documentos/README.txt`
- **Este documento:** Atualize esta página com o roteiro final

## Diretrizes para o Roteiro

- Estilo visual: Mauricio de Sousa (Turma da Mônica)
- Tom: Educativo e lúdico
- Público-alvo: Ensino Fundamental
- Idioma: Português

!!! tip "Template para Contribuição"
    Ao adicionar o roteiro, use o seguinte formato:
    ...
    **Legenda:** [Título do painel]
    
    **Balão de Fala (Isaac):** [Texto]
    ```
