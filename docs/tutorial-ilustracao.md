...
**Grátis:**
- Krita (Windows, macOS, Android)
- Medibang Paint (básico para quadrinhos)
- Canva (templates prontos)
- Pixton (online, personagens prontos)

**Pago:**
- Clip Studio Paint (melhor para quadrinhos)
- Adobe Photoshop (intermediário/avançado)
- Procreate (iPad)

**Tablet gráfico:** Wacom, Huion (opcional, mas recomendado)

## 2. Características do Estilo Mauricio de Sousa

!!! tip "Elementos Visuais Chave"
...
## 3. Passo-a-Passo: Do Esboço à Arte Final
...
**Exemplo para Newton:**
- Círculo grande para cabeça
- Corpo retangular arredondado
- Olhos: dois pontos com sobrancelha levantada
...
## 4. Exercício Prático: Newton em Estilo Turma da Mônica
