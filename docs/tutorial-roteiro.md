...
1. **Início (Introdução):** Apresenta o personagem e o contexto
2. **Meio (Desenvolvimento):** O conflito, a descoberta ou o problema
3. **Fim (Conclusão):** Resolução e aprendizado
...
## Dicas para o Estilo Mauricio de Sousa

!!! tip "Características do Estilo"
...
## Exemplo Prático (Baseado no Roteiro Existente)
...
!!! question "Perguntas para Stimular a Criatividade"
...
- **Humor:** Use expressões faciais exageradas para comedia
...
!!! example "Atividade para o Grupo"
    ...
    **Lei escolhida:** ___________________
    
    **Painel 1:** ___________________
    
    **Painel 2:** ___________________
...
!!! success "Dica Final"
    Não tenha medo de ser criativo! O objetivo é educar e divertir ao mesmo tempo.
    O estilo Mauricio de Sousa permite liberdade criativa mantendo a acessibilidade.
